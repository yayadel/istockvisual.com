...
Respond with a single JSON object only (no markdown fences), using exactly these keys:
{
  ...
  "tags": ["at least 40 tags merging keywords + categories + depicted elements"],
...
Do NOT output separate keywords, categories, or depictedElements fields — put all of those into tags (minimum 40 unique tags).
