...
import { IMAGE_SOURCE_NOTICE, LEGAL_CONTACT_EMAIL, SITE_BRAND } from './seo';
...
const FAQS: Faq[] = [
	{
		...
		answer: `512 and 1K downloads are free. 2K, 4K, and 8K need Pro. See /price. License is CC0: attribution is not required.`,
	},
	{
	...
	{
		keys: ['license', 'commercial', 'attribution', 'credit', 'copyright', 'ai', 'generated', 'source'],
		answer: `Library images are CC0: free for commercial and personal use, and you do not have to credit us. ${IMAGE_SOURCE_NOTICE} Optional credit: “Generated by ${SITE_BRAND}”. Full terms: /info/license.`,
	},
	{
