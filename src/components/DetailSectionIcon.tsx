...
const icons: Record<IconName, JSX.Element> = {
	...
	palette: (
		<svg viewBox="0 0 24 24" fill="none" aria-hidden="true">
			...
			<circle cx="8.2" cy="10.6" r="0.9" fill="currentColor" stroke="none" />
			<circle cx="11.1" cy="7.8" r="0.9" fill="currentColor" stroke="none" />
			<circle cx="15" cy="8.1" r="0.9" fill="currentColor" stroke="none" />
			<circle cx="16.8" cy="11.3" r="0.9" fill="currentColor" stroke="none" />
		</svg>
	),
	prompt: (
		<svg viewBox="0 0 24 24" fill="none" aria-hidden="true">
